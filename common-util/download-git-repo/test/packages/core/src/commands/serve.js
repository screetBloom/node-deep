...
const RomeDependence = require('../../class/rome-dependence/RomeDependence')
const { prepareURLs, prepareProxy, validateWebpackConfig, isAbsoluteUrl, DashboardPlugin } = new RomeDependence()
...
module.exports = (api, options) => {
  api.registerCommand('serve', {
    ...
    // webpackConfig.output.path = path.join(process.cwd(), options.outputDir)
    ...
    return new Promise((resolve, reject) => {
      ...
      compiler.hooks.done.tap('rome-cli-service serve', stats => {
        if (stats.hasErrors()) {
          return
        }
